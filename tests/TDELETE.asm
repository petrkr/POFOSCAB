...
;     on AH=0x41, or the int 0x24 critical-error path at all - DOSBox's
;     own DOS does not diverge from RBIL/raise critical errors on media
;     conditions the way DIP DOS does - same caveat as TMKDIR.
;
